        ...
        <>
            <div className='custom-footer-style mt-20 mb-10 lg:flex justify-between items-center font-semibold text-gray-500 bg-base-200 p-5'>
                ...
                <div className="flex gap-6 items-center my-5 lg:my-0 set-footer-link">
                    ...
                    <p><Link className='hover:text-black' to='/about'>About</Link></p>
                    <p><Link className='hover:text-black' to='/bookmark'>Bookmark</Link></p>
                    <p><Link className='hover:text-black' to='/cart'>Cart</Link></p>
                    <p><Link className='hover:text-black' to='/contact'>Contact</Link></p>
                </div>
