...
const Register = () => {
    ...
    const handleFromData = event => {
        ...
        createUser(email, password)
            .then(() => {
                updateProfileInfo({ displayName: dName, photoURL: photoURL })
                    .then()
        ...
        <div className="hero min-h-screen bg-base-200 mt-16">
            <div className="hero-content flex-col md:flex-row-reverse">
                <div className="text-center md:text-left">
                    ...
                    <p id='suggest' className='my-6 font-bold'>Create an account to get more benefit and explore the website...</p>
                </div>
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                    <form onSubmit={handleFromData} className="card-body respo">
                        <div className="form-control">
                            ...
                            <input name='dName' type="text" placeholder="Display Name" className="input input-bordered" required />
                        </div>
                        <div className="form-control">
                            <label className="label">
